...
const Hero = () => {  return (    <section className="relative py-16 sm:py-20 md:py-24 lg:py-28 overflow-hidden bg-gradient-to-b from-background to-primary/5 dark:from-background dark:to-primary/10">
      ...
      <div className="absolute top-0 left-0 right-0 bg-gradient-to-r from-accent to-primary py-2 text-center text-white z-30">
        ...
        >
          ...
          >
            <span className="font-bold">⚡ FLASH SALE ENDS TODAY:</span> Up to 30% OFF all plans + Free setup! Use code: <span className="font-bold bg-white/30 px-2 py-1 rounded ml-1 animate-pulse">SUMMER25</span>
          </motion.p>
        </motion.div>
      </div>
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-4 md:mb-6">
              <span className="relative inline-block">
                <span className="absolute -top-6 -right-6 bg-accent text-white text-sm px-3 py-1 rounded-full font-bold transform rotate-12 animate-pulse">30% OFF!</span>
