...
const Plans = () => {
  ...
  return (
    <section className="py-16 sm:py-20 md:py-24 bg-card relative overflow-visible" id="plans">
      ...
      <div className="container mx-auto px-6 relative z-10">        {/* Enhanced Heading section with countdown timer */}
        <motion.div 
        ...
        >
          {/* Enhanced sale announcement */}
          <motion.div 
            initial={{ scale: 1 }}
            animate={{ scale: [1, 1.05, 1] }}
            transition={{ duration: 2, repeat: Infinity }}
            className="inline-flex items-center bg-accent text-white text-xs sm:text-sm px-4 py-2 rounded-full font-bold mb-4 shadow-lg"
          >
          ...
          <div className="inline-flex items-center bg-primary/10 border border-primary/20 rounded-full px-4 py-1.5 mb-4">
          ...
          <p className="text-foreground/80 dark:text-muted-foreground text-sm sm:text-base md:text-lg max-w-2xl mx-auto px-4">
            Join <span className="font-bold text-primary">5000+</span> happy customers with <span className="font-bold">instant setup</span>, <span className="font-bold">24/7 support</span>, and <span className="font-bold">99.9% uptime guarantee</span>. Upgrade anytime as your community grows!
          </p>
          
          {/* Enhanced feature badges with icons */}
          <div className="flex flex-wrap items-center justify-center gap-2 mt-4">
            <div className="flex items-center bg-primary/20 text-primary text-xs px-3 py-1.5 rounded-full shadow-sm">
          ...
          <div className="mt-6 max-w-xs mx-auto bg-card/50 border border-border rounded-lg p-3 shadow-sm">
          ...
          {gameCategories[0].plans.slice(0, 4).map((plan, index) => (
            ...
            >              {/* Hover effect overlay */}
              ...
              <div className={`p-4 sm:p-6 rounded-t-[var(--radius-lg)] relative z-10 ${
                ...
                {/* Price section */}
              <div className="py-5 sm:py-6 px-6 text-center border-b border-border">
                <motion.div 
        ...
        </motion.div>        {/* Enhanced View All Plans Button with urgency and social proof */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        >
          <div className="mb-4 bg-card border border-border rounded-lg px-4 py-3 max-w-md shadow-sm">
          ...
          {/* Enhanced with urgency indicators */}
