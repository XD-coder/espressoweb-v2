...
import GameServerComparison from '../components/GameServerComparison';
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow relative">
        ...
        {/* Minecraft Server Hosting Types */}
        <section className="py-12 px-4 max-w-6xl mx-auto bg-card/50 rounded-lg my-8">
        ...
        {/* Special offer before footer */}
        <section className="py-12 md:py-16 bg-gradient-to-r from-accent/10 to-primary/10 relative overflow-hidden">
          <div className="container mx-auto px-4 sm:px-6 relative z-10">
            <div className="bg-card border border-border rounded-lg p-8 md:p-12 max-w-4xl mx-auto shadow-lg">
              <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12">
                <div className="md:w-1/3 flex justify-center">
                  <div className="relative w-40 h-40 bg-accent/20 rounded-full flex items-center justify-center">
                    ...
                    <div className="text-center">                      <div className="text-4xl font-bold text-accent">20%</div>
                      ...
                      <div className="text-xs font-medium text-accent">orders up to ₹500</div>
                    </div>
                  </div>
                </div>
                <div className="md:w-2/3 text-center md:text-left">
                  ...
                  <p className="text-foreground/80 mb-6">
                    Get 20% off all hosting plans (orders up to ₹500) when you sign up today. Use code <span className="font-mono bg-primary/20 text-primary px-2 py-1 rounded">SUMMER25</span> at checkout.
                  </p>
                  <a 
                    href="#plans" 
                    className="inline-block bg-accent hover:bg-accent-dark text-white px-6 md:px-8 py-3 rounded-lg font-bold shadow-md hover:shadow-lg transition-all duration-300"
                  >
                    Claim Discount Now
                  </a>
                </div>
