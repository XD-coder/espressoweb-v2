    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow py-20 bg-primary-50">
        <div className="container mx-auto px-6">
          <h1 className="text-5xl font-bold text-primary-950 text-center mb-12">Privacy Policy</h1>
          <div className="bg-white rounded-xl shadow-lg p-8 text-primary-800 leading-relaxed">
            ...
            <h2 className="text-3xl font-bold text-primary-950 mb-4">Interpretation and Definitions</h2>
            <h3 className="text-2xl font-semibold text-primary-950 mb-2">Interpretation</h3>
            <p className="mb-4">
              The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
            </p>
            <h3 className="text-2xl font-semibold text-primary-950 mb-2">Definitions</h3>
            <p className="mb-4">
            ...
            <ul className="list-disc list-inside mb-4 space-y-2">
              ...
              <li>
                <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Espresso Hosting.
              </li>
              <li>
              ...
              <li>
                <strong>Website</strong> refers to Espresso Hosting, accessible from <a href="https://espressohost.xyz" className="text-accent-500 hover:underline">https://espressohost.xyz</a>
              </li>
              <li>
                <strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.
              </li>
            </ul>
            <h2 className="text-3xl font-bold text-primary-950 mb-4">Collecting and Using Your Personal Data</h2>
            <h3 className="text-2xl font-semibold text-primary-950 mb-2">Types of Data Collected</h3>
            <h4 className="text-xl font-semibold text-primary-950 mb-2">Personal Data</h4>
            <p className="mb-4">
            ...
            <h4 className="text-xl font-semibold text-primary-950 mb-2">Usage Data</h4>
            <p className="mb-4">
            ...
            <h4 className="text-xl font-semibold text-primary-950 mb-2">Tracking Technologies and Cookies</h4>
            <p className="mb-4">
            ...
            <p className="mb-4">
              Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the <a href="https://www.privacypolicies.com/blog/privacy-policy-vs-cookies-policy/" target="_blank" rel="noopener noreferrer" className="text-accent-500 hover:underline">Privacy Policies website</a> article.
            </p>
            <p className="mb-4">
            ...
            <h3 className="text-2xl font-semibold text-primary-950 mb-2">Use of Your Personal Data</h3>
            <p className="mb-4">
            ...
            <h3 className="text-2xl font-semibold text-primary-950 mb-2">Sharing Your Personal Data</h3>
            <p className="mb-4">
            ...
            <h3 className="text-2xl font-semibold text-primary-950 mb-2">Retention of Your Personal Data</h3>
            <p className="mb-4">
            ...
            <h3 className="text-2xl font-semibold text-primary-950 mb-2">Transfer of Your Personal Data</h3>
            <p className="mb-4">
            ...
            <h3 className="text-2xl font-semibold text-primary-950 mb-2">Delete Your Personal Data</h3>
            <p className="mb-4">
            ...
            <h3 className="text-2xl font-semibold text-primary-950 mb-2">Disclosure of Your Personal Data</h3>
            <h4 className="text-xl font-semibold text-primary-950 mb-2">Business Transactions</h4>
            <p className="mb-4">
              If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
            </p>
            <h4 className="text-xl font-semibold text-primary-950 mb-2">Law enforcement</h4>
            <p className="mb-4">
              Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
            </p>
            <h4 className="text-xl font-semibold text-primary-950 mb-2">Other legal requirements</h4>
            <p className="mb-4">
            ...
            <h3 className="text-2xl font-semibold text-primary-950 mb-2">Security of Your Personal Data</h3>
            <p className="mb-4">
              The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.
            </p>
            <h2 className="text-3xl font-bold text-primary-950 mb-4">Links to Other Websites</h2>
            <p className="mb-4">
            ...
            <h2 className="text-3xl font-bold text-primary-950 mb-4">Changes to this Privacy Policy</h2>
            <p className="mb-4">
